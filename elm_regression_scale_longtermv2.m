function output = elm_regression_scale_longtermv2(train_series, test_series, NoHidden, N, Max, ahead, varargin)
...
for i=1:NoSeries
   ...
   F                    = compute_input_feature(X, overhead, ahead) /2; %column is an observation 
   Matrix_Regression =  [X( overhead+ ahead: end) F'];
