%This is the main file with HongTan Feature generator
...
%load('C:/Users/Daven/Dropbox/data/windmill/wind data/data_resampled.mat')
...
for i=1:length(N)
    temp= elm_regression_scale_longtermv2(train_series, test_series, NoHidden, N(i), Max, ahead, [save_file '_value1'], [save_file '_result1']);
    %output = [output ;temp];
end
...
figure; hold on
load (sprintf( '%s_result1 NoF = 29 NoH = 200 regression', save_file));
plot( TY2(1: d))
